...
export default function FeatureCard({ featureItem = {} }) {
	...
	return (
		<div
			className='w-full min-h-60 p-5 border-2 border-base-content rounded-xl flex flex-col items-center gap-2 transition-all duration-100 shadow-none hover:shadow-2xl hover:scale-110 bg-base-100'
